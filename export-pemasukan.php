...
$pdf->SetTitle('Data Pemasukan PDF');
...
$pdf->Output('/home/u676389388/domains/pcippnu.com/keuangan_yuni/Data_Pemasukan.pdf', 'F');
echo '<script>window.location.href = "/Data_Pemasukan.pdf";</script>';
?>